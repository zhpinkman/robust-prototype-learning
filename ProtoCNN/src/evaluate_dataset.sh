...
CUDA_VISIBLE_DEVICES=3,4,5,6 python evaluate_dataset.py \
    ...
    --model_checkpoint="/scratch/darshan/prototype-learning/robust-prototype-learning/ProtoCNN/src/checkpoints/imdb/epoch_0=00-val_loss_0=0.4771-val_acc_0=0.8152.ckpt" \
    --name "normal" \
    --num_labels=2
